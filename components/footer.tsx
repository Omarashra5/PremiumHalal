        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <h3 className="text-primary font-bold text-lg tracking-wider uppercase">The Food Wagon</h3>
                <p className="text-muted-foreground text-xs tracking-widest">WHERE FLAVOR HITS THE ROAD</p>
              </div>
            </div>
            <p className="text-muted-foreground text-sm mb-3">
              Premium Halal Street Food in Ingolstadt. Burgers, Fried Chicken, Currywurst and more.            </p>
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-4">
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-muted-foreground text-sm">
              <p>© {new Date().getFullYear()} Flavor Bytes GmbH. All rights reserved.</p>
