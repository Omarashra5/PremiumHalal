...
Premium Halal Burgers, crispy Fried Chicken and authentic Currywurst – straight from the food truck to you.        </p>
        ...
        <div className="max-w-xl mx-auto mb-16 p-6 md:p-8 bg-primary/10 rounded-2xl border-2 border-primary/30 backdrop-blur-sm">
          <div className="flex items-center justify-center gap-4 md:gap-6">
            ...
            <div className="text-left">
              <p className="text-primary font-black text-2xl md:text-3xl lg:text-4xl mb-1">Every Saturday</p>
              <p className="text-foreground font-bold text-base md:text-lg lg:text-xl">Am Cairo 7, Ingolstadt</p>
              <p className="text-muted-foreground text-sm md:text-base mt-1">AM 11:00 - 12:00 PM</p>
            </div>
          </div>
        </div>
