        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="p-8 bg-card border border-border rounded-2xl">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Saturday: 11:00 - 20:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-primary/10 border border-primary/30 rounded-xl">
              <h4 className="text-xl font-bold text-primary mb-2">Parties, Events & Festivals</h4>
              <p className="text-foreground">
                We also cater for your private events! Contact us for a customized quote.              </p>
            </div>
          </div>
        </div>
      </div>
